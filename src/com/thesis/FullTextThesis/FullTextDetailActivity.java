 ...
 */
public class FullTextDetailActivity extends Activity {
    static{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fulltextdetail_activity);
        listView = (ListView)findViewById(R.id.listView);
        String fulltext_id = getIntent().getExtras().getString("fulltext_id");
        String fulltext_name = getIntent().getExtras().getString("fulltext_name");
        String fulltext_details = getIntent().getExtras().getString("fulltext_details");
        String fulltext_year = getIntent().getExtras().getString("fulltext_year");
        String datetime_add = getIntent().getExtras().getString("datetime_add");
        ((TextView)findViewById(R.id.txtDetail)).setText(String.format("Name : %s\nYear : %s\nDate Add : %s\nDetail : %s",fulltext_name,fulltext_year,datetime_add,fulltext_details));
        ...
        String url = "http://10.0.2.2/thesis_db11/androidFullTextDetail.php";
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("fulltext_id", fulltext_id));
        try {
            ...
            SimpleAdapter sAdap;
            sAdap = new SimpleAdapter(FullTextDetailActivity.this, MyArrList, R.layout.fulltextdetaillist_activity,
                    new String[] {"order","filefulltext_name", "filefulltext_size"}, new int[] {R.id.Colorder,R.id.Colfilefulltext_name, R.id.Colfullfilefulltext_size});
